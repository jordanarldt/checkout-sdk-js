...
// TODO: should be removed when BRAINTREE_PAYPALV2 and BRAINTREE_PAYPAL_CREDITV2 registries will be removed
const mapCheckoutButtonMethodId = (methodId: CheckoutButtonMethodType) => {
    if (methodId === CheckoutButtonMethodType.BRAINTREE_PAYPALV2) {
        return CheckoutButtonMethodType.BRAINTREE_PAYPAL;
    }
